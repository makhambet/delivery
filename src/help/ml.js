...
export default new MLCreate({
  ...
  languages: [
    new MLanguage('ru').create({
        ...
        write_message: 'Если у вас есть вопрос, пишите нам письмо help@info.kz',
        delivery_phone: 'Телефон доставки в г.Алматы',
        ...
        min_price: 'Минимальная сумма заказа должна превышать 5000 тг',
        profile: 'Профиль',
        name: 'Имя',
        phone: 'Номер',
    ...
    new MLanguage('en').create({
        ...
        write_message: 'If you have a question, write us an email help@info.kz',
        ...
        min_price: 'Minimum order stats from 5000 tenge',
        profile: 'Profile',
        name: 'Name',
        phone: 'Phone',
